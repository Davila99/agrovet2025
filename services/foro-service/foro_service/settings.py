"""
Django settings for foro-service microservice.
"""
...
ROOT_URLCONF = 'foro_service.urls'
...
WSGI_APPLICATION = 'foro_service.wsgi.application'

# Database
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DB_NAME', 'foro_db'),
